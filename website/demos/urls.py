...
urlpatterns = [
    ...
    path("download/<slug:slug>/", views.download, { "dl": 1 }, name="download"),
    path("download/2/<slug:slug>/", views.download, { "dl": 2 }, name="download/2"),
    path("download/3/<slug:slug>/", views.download, { "dl": 3 }, name="download/3"),
    path("explore/<slug:slug>/", views.explore, { "disc": 1, "osx": False }, name="explore"),
    path("explore/osx/<slug:slug>/", views.explore, { "disc": 1, "osx": True }, name="explore/osx"),
    path("explore/2/<slug:slug>/", views.explore, { "disc": 2, "osx": False }, name="explore/2"),
    path("explore/2/osx/<slug:slug>/", views.explore, { "disc": 2, "osx": True  }, name="explore/2/osx"),
    path("explore/3/<slug:slug>/", views.explore, { "disc": 3, "osx": False }, name="explore/3"),
    path("explore/3/osx/<slug:slug>/", views.explore, { "disc": 3, "osx": True  }, name="explore/3/osx"),
    path("explore/4/<slug:slug>/", views.explore, { "disc": 4, "osx": False }, name="explore/4"),
    path("explore/4/osx/<slug:slug>/", views.explore, { "disc": 4, "osx": True  }, name="explore/4/osx"),
