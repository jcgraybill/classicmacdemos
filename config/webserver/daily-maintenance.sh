...
/usr/bin/sqlite3 /home/ec2-user/classicmacdemos/website/db.sqlite3 "UPDATE demos_download SET downloads = 0 WHERE game_id IN (select id from demos_game where game like 'Living Books%');"
